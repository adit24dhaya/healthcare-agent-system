...
class RecommendationAgent:
    ...
    def recommend(self, patient_data, risk, retrieved_context=None, similar_cases=None):
        if self.client is None:
            return self._fallback_recommendation(patient_data, risk, retrieved_context, similar_cases)
        ...
        try:
            ...
            return f"{self._fallback_recommendation(patient_data, risk, retrieved_context, similar_cases)} LLM recommendation unavailable: {exc}"

    def _fallback_recommendation(self, patient_data, risk, retrieved_context=None, similar_cases=None):
        glucose_note = ""
        ...
        return recommendation + glucose_note + context_note + memory_note
